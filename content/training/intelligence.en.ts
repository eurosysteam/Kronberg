...
export const intelligenceEn: TrainingTaskContent = {
  ...
  sections: [
    {
      title: "Incomplete customer inquiries and limited technical knowledge in the sales team",
      body: [
    ...
    {
      title: "Cultural differences with international customers",
      body: [
    ...
    {
      title: "Challenges in onboarding new sales employees",
      body: [
