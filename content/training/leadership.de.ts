...
export const leadershipDe: TrainingTaskContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Ausgangslage: Oliver Brandt, Leiter Key Account Management, und Jana Weber, Leiterin Service DACH, betreuen einen strategisch wichtigen Großkunden. Oliver erwartet schnelle und flexible Zusagen, um die Kundenbeziehung nicht zu gefährden. Jana kritisiert hingegen, dass der Vertrieb wiederholt Leistungen und Reaktionszeiten in Aussicht stellt, die der Service mit den vorhandenen Kapazitäten kaum einhalten kann. Nach einer angespannten Abstimmung ist der Konflikt per E-Mail offen eskaliert. Beide fühlen sich von der jeweils anderen Seite nicht ernst genommen. Einige Teammitglieder beziehen Position, und in fünf Tagen findet ein gemeinsamer Kundentermin statt. Sabine Vogel muss zunächst Einzelgespräche und anschließend ein gemeinsames Klärungsgespräch führen. Der Chatbot soll sie bei der Vorbereitung, Simulation und Auswertung aller drei Gespräche unterstützen.",
      ],
