...
export const leadershipDe: TrainingTaskContent = {
  ...
  sections: [
    ...
    },
    {
      title: "Ihre Aufgabe",
      body: [
        "Entwickeln Sie aus Sicht von Sabine Vogel einen KI-Bot-Prototypen für eine der drei beschriebenen Führungsherausforderungen. Der Bot soll nicht alle Probleme gleichzeitig lösen. Wählen Sie einen klaren Schwerpunkt und zeigen Sie, wie die Lösung die Führungsarbeit konkret verbessert.",
        "Bereiten Sie eine 5–7-minütige Präsentation inklusive einer kurzen Demonstration Ihres KI-Bot-Prototyps vor.",
        "In der Demonstration soll erkennbar werden, welche Fragen der Bot stellt, wie er mit unvollständigen Angaben umgeht und welchen konkreten Mehrwert er Sabine Vogel als Führungskraft bietet.",
      ],
    },
  ],
  support: {
