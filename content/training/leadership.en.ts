  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "First work without a laptop and capture your thinking on a poster.",
        "**Guiding questions**",
        "**Which specific leadership task should the bot support Sabine Vogel with?** Which situation, decision or conversation preparation is at the center?",
        "**What support should the bot provide – and what must it not take over?** Define functions, role, boundaries and necessary safeguards.",
        ...
        "Run through realistic leadership situations.",
        "Test incomplete information and difficult cases.",
        "Review quality, usefulness and limitations.",
